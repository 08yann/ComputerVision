...
models_dict = {'VAE_1D':VAE_1D, 'VAE_3D':VAE_3D, 'VAE_complex':VAE_complex, 'MultiStage_VAE': MultiStage_VAE, 'ResNet': ResNet, 'VQ_VAE': VQ_VAE}
...
if args.mod != 'sample':
    ...
    evaluation_step(model, test_dataloader, kl_weight, unnormalize, classification, writer)
